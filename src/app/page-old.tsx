            ...
            <div className="grid lg:grid-cols-2 gap-20 lg:gap-24 items-center">
              ...
              >
                <div className="space-y-8">
                  <motion.div
                    ...
                    className="inline-flex items-center space-x-2 bg-blue-50 text-blue-700 px-4 py-2 rounded-full text-sm font-semibold"
                  >
                  ...
                  <h1 className="text-5xl lg:text-7xl font-bold leading-tight tracking-tight text-neutral-900">
                    Create{' '}
                    <span className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">Intelligent</span>{' '}
                    Political Cartoons
                  </h1>
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -bottom-4 -left-4 w-8 h-8 bg-blue-500 rounded-full shadow-md"
                />
              </motion.div>
            </div>
          </div>
